...
def main():
    ...
    parser.add_argument(
        ...
        "--log-filename",
        dest="log_fname",
        default=log_fname_default,
        type=str,
        help="Output JSON log filename",
    )
    parser.add_argument(
        "-i",
        "--initiator",
        dest="initiator_dev_num",
        default=initiator_dev_num_default,
        type=int,
        help="Reader device number",
    )
    parser.add_argument(
        "-t",
        "--target",
        dest="target_dev_num",
        default=target_dev_num_default,
        type=int,
        help="Emulator device number",
    )
    parser.add_argument(
        "-n",
        "--no-easy-framing",
        dest="no_easy_framing",
        action="store_true",
        help="Do not use easy framing. transfer data as frames instead of APDUs",
    )
    parser.add_argument(
        "-p",
        "--print-log",
    ...
    parser.add_argument(
        ...
        dest="hook_data",
        action="store_true",
        help="Use data hook function for data processing",
    )
